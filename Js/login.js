var emailIDorPhno=localStorage.getItem("mailIdOrphnno")
...
function passVis()
{
    ...
    document.getElementById("passvis").src="./Assect/Images/openeyes.png";
...
function passHid()
{
    ...
    document.getElementById("passvis").src="./Assect/Images/closeeyes.jpg"
}
function bigButton()
{
